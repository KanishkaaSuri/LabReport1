...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\kanis\\Desktop\\Lab in Psychology\\Staircase Experiment\\StaircaseExperiment_lastrun.py',
...
conditions = data.importConditions('cons.xlsx')
